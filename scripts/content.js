// API TO FETCH
// https://cdn-api-prd.sounds.com/api/search?sound_id=1977589
...
const rows = () => {
  const table = document.getElementsByClassName("sound-table-rows")[0];
  const rows = table.getElementsByClassName("sounds-row-grid");

  return rows;
};

const addDownloadIcon = (sample) => {
